...
const pointLight = new THREE.PointLight(0xff9000, 0.5, 3.5);
...
const spotLightHerlper = new THREE.SpotLightHelper(spotLight, 0.1);
scene.add(spotLightHerlper);

window.requestAnimationFrame(() => {
  spotLightHerlper.update();
});
