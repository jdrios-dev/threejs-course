...
const tick = () => {
  ...
  ghost2.position.x = 1 + Math.cos(ghost2Angle) * 5;
  ghost2.position.z = Math.sin(ghost2Angle) * 5;
  ghost2.position.y = Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 2.5);

  const ghost3Angle = -elapsedTime * 0.2;
  ghost3.position.x = Math.cos(ghost3Angle) * (6 + Math.sin(elapsedTime * 3.2));
  ghost3.position.z = Math.sin(ghost3Angle) * (6 + Math.sin(elapsedTime * 1.5));
  ghost3.position.y = Math.sin(elapsedTime * 4) + 1;
